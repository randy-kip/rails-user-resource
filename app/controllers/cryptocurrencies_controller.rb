  ...
  def create
    ...
    respond_to do |format|
      if @cryptocurrency.save
        format.html { redirect_to cryptocurrency_url(@cryptocurrency), notice: "Cryptocurrency was successfully created." }
  ...
  def update
    respond_to do |format|
      if @cryptocurrency.update(cryptocurrency_params)
        format.html { redirect_to cryptocurrency_url(@cryptocurrency), notice: "Cryptocurrency was successfully updated." }
